...
VALUES 
    ('Complejo Deportivo Miraflores', 'futbol', 'cancha', -12.1181, -77.0302, 'Av. Principal 123', 'Canchas de fútbol de alta calidad', 'seguridad,baños,iluminación', 4.8, 50.0, 1, 1686700000000, 1686700000000),
    ...
    ('Piscina Olímpica', 'natacion', 'cancha', -12.0800, -77.0300, 'Av. Deportes 456', 'Piscina olímpica temperatura controlada', 'seguridad,baños,vestuarios', 4.9, 30.0, 3, 1686720000000, 1686720000000);
