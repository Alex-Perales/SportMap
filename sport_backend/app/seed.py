...
PLACES = [
    (1, "Cancha Fútbol San Borja",     "futbol",    "cancha",    -12.0856, -77.0268, True,  "Cancha de fútbol 11 en San Borja con césped sintético de alta calidad e iluminación.",       "seguridad,baños,iluminación,vestuarios,parking",             "https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800", 4.6, 120.0, 48),
    (2, "Club Tenis San Borja",         "tenis",     "cancha",    -12.0945, -77.0315, True,  "4 canchas de tenis de polvo de ladrillo. Clases con instructores certificados.",              "seguridad,baños,vestuarios,cafetería,parking",                "https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800", 4.8,  60.0, 44),
    (3, "Cancha Vóley San Borja",       "voley",     "cancha",    -12.0982, -77.0201, True,  "Cancha municipal de vóley con red reglamentaria. Reserva tu hora de 6am a 10pm.",           "iluminación,baños,seguridad",                                 "https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?w=800", 4.1,  40.0, 50),
    (4, "Circuito Mágico del Agua",     "bienestar", "bienestar", -12.0712, -77.0102, True,  "Parque con fuentes interactivas y senderos. Ideal para caminatas y relajación.",             "baños,seguridad,iluminación,bancas",                          "https://images.unsplash.com/photo-1519331379826-f10be5486c6f?w=800", 4.7,  10.0, 52),
    ...
    (8, "Parque Central Miraflores",    "bienestar", "bienestar", -12.1302, -77.0248, True,  "Parque céntrico con áreas verdes para yoga, tai chi y meditación al aire libre.",           "baños,bancas,iluminación,seguridad",                          "https://images.unsplash.com/photo-1545389336-cf090694435e?w=800", 4.6,   5.0, 40),
    (9, "Cancha Natación Miraflores",   "natacion",  "cancha",    -12.1178, -77.0340, True,  "Piscina olímpica de 50m con 8 carriles. Programas de natación para todas las edades.",     "seguridad,baños,vestuarios,duchas,cafetería",                 "https://images.unsplash.com/photo-1530549387789-4c1017266635?w=800", 4.7,  30.0, 38),
    (10, "Jockey Club",                 "tenis",     "cancha",    -12.0956, -77.0385, True,  "8 canchas de tenis de primer nivel (polvo y dura). Sede de torneos ATP challenger.",        "seguridad,baños,vestuarios,restaurante,parking valet",        "https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800", 4.9,  90.0, 42),
    (11, "Parque Botánico San Isidro",  "bienestar", "bienestar", -12.0901, -77.0341, True,  "Reserva verde de 5 hectáreas. Senderos de meditación y áreas de yoga.",                    "bancas,sombra natural,bebederos,seguridad",                   "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=800", 4.8,   5.0, 28),
    (12, "Zona Deportiva San Isidro",   "futbol",    "cancha",    -12.0875, -77.0412, True,  "Complejo deportivo con canchas de fútbol 7 y 11. Reserva con anticipación.",               "baños,iluminación,tribuna,estacionamiento,vestuarios",        "https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800", 4.3,  20.0, 46),
]
